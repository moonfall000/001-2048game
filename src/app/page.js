...
const CHEST_LEVEL_CONFIGS = {
  ...
  30: { cost: 500000000, rates: { '普通': 0.00, '優秀': 0.00, '精良': 0.00, '史詩': 0.00, '傳說': 0.00, '神話': 0.00, '不朽': 0.25, '超越': 0.40, '鎏金': 0.30, '永恆': 0.04999 , '至尊': 0.00001 } },
};
...
const NAMES_BY_SLOT = {
  '武器': ['新手木杖', '菇菇合金短刃', '拔山蓋世神劍', '不滅至尊弒神歌'],
  '頭盔': ['大綠葉帽', '厚皮兜帽', '璀璨琉璃聖盔', '至尊龍皇耀光冕'],
  '胸甲': ['破舊布衣', '常春藤輕甲', '不落要塞重鎧', '反物質粒子戰甲'],
  '鞋子': ['破爛草鞋', '旅行者皮靴', '疾風逐影輕履', '踏碎虛空逆時靴'],
};
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '20px' }}>
        ...
        <div style={boxStyle}>
          ...
          <div style={{ marginTop: '16px', backgroundColor: '#020617', padding: '12px', borderRadius: '12px', border: '1px solid #1e293b', fontSize: '12px' }}>
            ...
            <div style={{ maxHeight: '180px', overflowY: 'auto', paddingRight: '4px', display: 'flex', flexDirection: 'column', gap: '2px' }}>
              {filteredLeaderboard.length > 0 ? (
                ...
                <div style={{ color: '#475569', textAlign: 'center', padding: '20px 0', fontStyle: 'italic' }}>查無此菇勇者玩家...</div>
              )}
            </div>
